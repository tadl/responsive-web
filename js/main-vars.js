...
var FEATURED_URL = 'http://www.tadl.org/mobile/export/items/json/featured';
var EVENTS_URL = 'http://www.tadl.org/mobile/export/events/json/all';
var NEWS_URL = 'http://www.tadl.org/export/news/json';
...
var loadmoreText = '<a class="button large tadlblue" onclick="loadmore();">More Results</a>';
